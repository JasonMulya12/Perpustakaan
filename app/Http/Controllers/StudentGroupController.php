...
class StudentGroupController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('studentGroup.index',compact('studentGroups'))->with('i', (request()->input('page', 1) - 1) * 5);
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('studentGroup.index')->with('success', 'Berhasil Menyimpan!');
    }
    ...
    public function update(Request $request, StudentGroup $studentGroup)
    {
        ...
        return redirect()->route('studentGroup.index')->with('success', 'Berhasil Update!');
    }
    ...
    {
        $studentGroup->delete();
        return redirect()->route('studentGroup.index')->with('success', 'Berhasil Hapus!');
    }
}
